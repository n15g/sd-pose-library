...
class TestPackage(TestCase):
    def test_load(self):
        pkg = Package(os.path.join(os.path.dirname(__file__), "db", "test_package"))
    ...
    def test_load_no_meta(self):
        pkg = Package(os.path.join(os.path.dirname(__file__), "db", "no_meta"))
    ...
    def test_load_partial_meta(self):
        pkg = Package(os.path.join(os.path.dirname(__file__), "db", "partial_meta"))
